    ...
    <div className="bg-background">
      ...
      <div className="w-full py-1 sm:py-2 md:py-2">
        ...
        <ResizablePanelGroup direction="horizontal" className="w-full" style={{ alignItems: 'flex-start' }} onLayout={handlePanelLayout}>
          ...
          {/* Sidebar divider with visible handle */}
          <ResizableHandle 
            withHandle
            className="relative group bg-transparent hover:bg-[#F0F0F2] transition-colors"
            style={{ 
              width: '10px',
              cursor: 'col-resize',
          ...
          {/* Floating expand button when sidebar is collapsed - positioned at sidebar content left edge */}
          {isSidebarCollapsed && (
            <button
